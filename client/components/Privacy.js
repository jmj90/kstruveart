                ...
                <div id="contact-viewport-policy">
                  ...
                  <h1>PRIVACY POLICY</h1>
                    <p>
                      ...
                      understand the way in which other websites garner, make use of and share information collected.

                      <h3>Use of Information Collected</h3>
                      STRUVE FINE ART may collect and may make use of personal information to assist
                      ...
                      information as a means to keep you informed of other possible products and/or services
                      that may be available to you from www.kstruve.com . STRUVE FINE ART may also be in
                      contact with you with regards to completing surveys and/or research questionnaires
                      related to your opinion of current or potential future services that may be offered.

                      <br /><br />
                      STRUVE FINE ART does not now, nor will it in the future, sell, rent or lease any of our customer lists and/or names to any third parties.
                      <br /><br />
                      STRUVE FINE ART may disclose your personal information, without prior notice to you, only if required to do so in accordance with applicable laws and/or in a good faith belief that such action is deemed necessary or is required in an effort to:
                      <br />
                      • Remain in conformance with any decrees, laws and/or statutes or in an effort to comply with any process which may be served upon STRUVE FINE ART and/or our website;
                        <br />
                      • Maintain, safeguard and/or preserve all the rights and/or property ofSTRUVE FINE ART; and
                        <br />
                      • Perform under demanding conditions in an effort to safeguard the personal safety of users of www.kstruve.com and/or the general public.
                        <br />
                      <h3>Children Under Age of 13</h3>
                      STRUVE FINE ART does not knowingly collect personal identifiable information from children under the age of thirteen (13) without verifiable parental consent. If it is determined that such information has been inadvertently collected on anyone under the age of thirteen (13), we shall immediately take the necessary steps to ensure that such information is deleted from our
                      system's database. Anyone under the age of thirteen (13) must seek and obtain parent or guardian permission to use this website.
                      <br /><br />
